	...
	<div class="container3">
    	<div class="c3_b1">
               		...
               		<dd>
                    	...
                    	<p>
                   		  <c:forEach items="${entry.value }" var="det">
                      		  <a href="toList?detid=${det.id}">${det.name}</a>
                   		   </c:forEach>
                      	</p>
                    </dd>
            	</c:forEach>
            ...
            <div class="c3_b1_center">
            	<div>
                	<a href="b/viewBook.html"><img src="images/ad1.png"></a>
                </div>
                <div class="c3_b1_c_bottom">
                    <ul>
                        ...
                        <li>
                           <a href="toviewBook?id=${pro.id }"><img src="${pro.img }" width=150 height=151/></a>
                           <a href="toviewBook?id=${pro.id }">${pro.name }</a>  
                        </li>
                    	</c:forEach>
